...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UbicacionNoEncontradaException.class, OrdenPickingNoEncontradaException.class})
    ...
    @ExceptionHandler(EstadoPickingInvalidoException.class)
    public ResponseEntity<ErrorResponse> handleInvalidState(EstadoPickingInvalidoException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ErrorResponse> handleStockInsuficiente(StockInsuficienteException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                ...
                .error("Conflict - Stock Insuficiente")
                .message(ex.getMessage())
                .path(request.getRequestURI())
                .build();
