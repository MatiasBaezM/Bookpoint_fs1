package cl.bookpointchile.inventario.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ResourceNotFoundException.class, SucursalNoEncontradaException.class})
    ...
    public ResponseEntity<ErrorResponse> handleBadRequestBusinessExceptions(StockInsuficienteException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
